...
google.charts.load('current', {packages: ['corechart', 'bar']});
        ...
        data.addRows([
            [{v: [7, 0, 0], f: '7 am'}, result[0].count, /*3*/],
            [{v: [8, 0, 0], f: '8 am'}, result[1].count, /*2*/],
            [{v: [9, 0, 0], f: '9 am'}, result[13].count, /*.5*/],
            [{v: [10, 0, 0], f:'10 am'}, result[14].count, /*1*/],
            [{v: [11, 0, 0], f: '11 am'}, 10, /*2.25*/],
